#ifndef LayerTilesSYCL_h
#define LayerTilesSYCL_h
...
private:
  sycltools::VecArray<sycltools::VecArray<int, LayerTilesConstants::maxTileDepth>, LayerTilesConstants::nColumns * LayerTilesConstants::nRows> layerTiles_;
};
#endif
